...
```
npm test                 # all 18 unit suites below (829 checks) — must pass
...
node tests/furniFootprint.test.js      # multi-tile footprints derived from dims, verified against the drop-shadow art (38 checks)
