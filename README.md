...
```
npm test                 # all 18 unit suites below (840 checks) — must pass
...
node tests/furniFootprint.test.js      # multi-tile footprints derived from dims, verified against the drop-shadow art, plus zdim stacking (49 checks)
