        ...
        <HabboPanel title="Available Servers">
          {loading ? (
            ...
            <div className="space-y-6">
              ...
              {/* PVP Coming Soon Section */}
              <div className="space-y-3 mt-6">
                <h3 className="font-bold text-lg flex items-center gap-2">
                  <span className="px-3 py-1 bg-primary text-primary-foreground rounded">PVP</span>
                  Arenas
                </h3>
                 <div className="flex items-center justify-between p-6 bg-muted/30 rounded-lg border-2 border-dashed border-border">
                   <div>
                     <div className="font-bold text-lg text-foreground">Player vs Player Combat</div>
                     <div className="text-sm text-muted-foreground">Test your skills against other adventurers in real-time battles</div>
                   </div>
                  <div className="px-6 py-2 bg-primary/10 text-primary font-bold rounded-lg border border-primary/20">
                    COMING SOON
                  </div>
                </div>
              </div>
